...
import com.github.tgda.knowledgeManage.applicationService.ruleEngine.RuleEngineService;
...
public class RelationExtractProcessor implements BaseCommandProcessor{
    ...
    public RelationExtractProcessor(Engine coreRealm, ExecutorService executor, Map<Object,Object> commandContextDataMap){
