...
***
# <span style="color:#CE0000;"> Dat Compute  </span>Java SDK API 说明
...
```java
   /**
     ...
     * @return 如果操作成功返回 true
     */
    public boolean removeGeospatial(String geospatialRegionName) throws CoreRealmServiceRuntimeException;
