...
import com.github.tgda.compute.consoleApplication.exception.ApplicationInitException;
...
public class ComputeApplicationLauncher {
    ...
    private static Logger logger = LoggerFactory.getLogger(ComputeApplicationLauncher.class);
