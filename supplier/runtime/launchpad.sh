...
# NAME:launchpad.sh
#
# FUNCTION: 启动 Analysis Provider 服务节点.
#
...
LIB="$WORKINGDIR/TGDA_analysisProvider-1.0.0.jar":"$LIB"
#echo $LIB
...
-cp $EXTENDCLASSPATH:$LIB "com.github.tgda.analysisProvider.providerApplication.AnalysisProviderApplicationLauncher"
