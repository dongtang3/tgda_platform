...
public class GSLCaseTestV2_01 {
    public static void main(String[] args) throws EngineServiceEntityExploreException, EngineServiceRuntimeException {
    ...
    private static void cleanExecutiveProperties() throws EngineServiceEntityExploreException, EngineServiceRuntimeException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
        ...
        List<Entity> conceptionEntityList = conceptionEntitiesRetrieveResult.getConceptionEntities();
        for(Entity currentEntity:conceptionEntityList){
        ...
        for(Entity currentEntity:conceptionEntityList){
            ...
            if(idNOAttributeValue!=null){
                ...
                if(currentIDValue.startsWith(" ")){
                    currentEntity.updateAttribute("CERTIFICATE_NO",currentIDValue.trim());
                }
            }
        }
    ...
    private static void linkSamePerson() throws EngineServiceEntityExploreException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
        ConceptionKind conceptionKind = coreRealm.getConceptionKind("Executive");
        QueryParameters queryParameters2 = new QueryParameters();
        queryParameters2.setResultNumber(10000000);
        ...
        for(EntityValue currentEntityValue:conceptionEntityValueList){
            Map<String,Object> propMap = currentEntityValue.getEntityAttributesValue();
        ...
        for(EntityValue currentEntityValue:conceptionEntityValueList2){
            Map<String,Object> propMap = currentEntityValue.getEntityAttributesValue();
            String entityUID = currentEntityValue.getEntityUID();
        ...
        for(Map.Entry<String, String> entry:personIDAndEntityUIDMap.entrySet()){
            ...
            if(individualIDAndEntityUIDMap.containsKey(personID)){
                RelationshipEntityValue currentRelationshipEntityValue = new RelationshipEntityValue(null,individualIDAndEntityUIDMap.get(personID),entityUID,null);
                relationEntityValueList.add(currentRelationshipEntityValue);
            }
        }
        Map<String,Object> operationResult =null;
...
*/
    ...
    private static void linkFederationOfIndustryAndCommerceGeo() throws EngineServiceEntityExploreException, EngineServiceRuntimeException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
        /*
        ...
        */
        ...
        for(EntityValue conceptionEntityValue:conceptionEntityValueList){
            ...
            if(attributesMap.containsKey("XIAN")){
                _XIANDataMap.put(conceptionEntityValue.getEntityUID(),attributesMap.get("XIAN").toString());
            }else if(attributesMap.containsKey("SHI")){
                _SHIDataMap.put(conceptionEntityValue.getEntityUID(),attributesMap.get("SHI").toString());
            }else {
                if (attributesMap.containsKey("SHENG")){
                    _SHENGDataMap.put(conceptionEntityValue.getEntityUID(),attributesMap.get("SHENG").toString());
                }
            }
        }
        ...
        Map<String,Object> attachResult = BatchDataOperationUtil.batchAttachGeospatialScaleEventsByGeospatialCode(_SHENGDataMap,"organizationAdministrativeAtDistrict",null, Geospatial.GeospatialScaleGrade.PROVINCE,BatchDataOperationUtil.CPUUsageRate.Low);
        System.out.println(attachResult);
        attachResult = BatchDataOperationUtil.batchAttachGeospatialScaleEventsByGeospatialCode(_SHIDataMap,"organizationAdministrativeAtDistrict",null, Geospatial.GeospatialScaleGrade.PREFECTURE,BatchDataOperationUtil.CPUUsageRate.Low);
        System.out.println(attachResult);
        attachResult = BatchDataOperationUtil.batchAttachGeospatialScaleEventsByGeospatialCode(_XIANDataMap,"organizationAdministrativeAtDistrict",null, Geospatial.GeospatialScaleGrade.COUNTY,BatchDataOperationUtil.CPUUsageRate.Middle);
        System.out.println(attachResult);
    }

    private static void linkKindGeo(String kindName,String levelProperty,String eventComment,String provinceProperty,String cityProperty,String countyProperty) throws EngineServiceEntityExploreException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
        ...
        for(EntityValue conceptionEntityValue:conceptionEntityValueList){
            ...
            if(_ADMINI_LEVEL.trim().equals("地市级")){
                ...
                _SHIDataMap.put(conceptionEntityValue.getEntityUID(),geoName);
            }

            if(_ADMINI_LEVEL.trim().equals("省级")){
                if(!attributesMap.get(provinceProperty).equals("全国"));{
                    _SHENGDataMap.put(conceptionEntityValue.getEntityUID(),attributesMap.get(provinceProperty).toString());
                }
            }
        }
        System.out.println(_XIANDataMap.size());
        ...
        Map<String,Object> attachResult = BatchDataOperationUtil.batchAttachGeospatialScaleEventsByChineseNames(_SHENGDataMap,eventComment,null, Geospatial.GeospatialScaleGrade.PROVINCE,BatchDataOperationUtil.CPUUsageRate.High);
        System.out.println(attachResult);
        attachResult = BatchDataOperationUtil.batchAttachGeospatialScaleEventsByChineseNames(_SHIDataMap,eventComment,null, Geospatial.GeospatialScaleGrade.PREFECTURE,BatchDataOperationUtil.CPUUsageRate.High);
        System.out.println(attachResult);
        attachResult = BatchDataOperationUtil.batchAttachGeospatialScaleEventsByChineseNames(_XIANDataMap,eventComment,null, Geospatial.GeospatialScaleGrade.COUNTY,BatchDataOperationUtil.CPUUsageRate.High);
        System.out.println(attachResult);
    }

    private static void linkEnterpriseMemberDate() throws EngineServiceEntityExploreException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
        ...
        List<EntityValue> conceptionEntityValueList = conceptionEntitiesAttributeResult.getEntityValues();
    ...
    private static void linkIndividualMemberDate() throws EngineServiceEntityExploreException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
    ...
    private static void linkExecutiveDate() throws EngineServiceEntityExploreException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
    ...
    private static void linkExecutiveEnterpriseDate() throws EngineServiceEntityExploreException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
    ...
    private static void linkChamberOfCommerceDate() throws EngineServiceEntityExploreException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
    ...
    private static void createCPCOrganizationForChamberOfCommerce() throws EngineServiceEntityExploreException, EngineServiceRuntimeException {
        CoreRealm coreRealm = EngineFactory.getDefaultEngine();
        coreRealm.openGlobalSession();
...
PARTY_SECRETARY
        ...
        for(EntityValue _EntityValue : _ConceptionEntitiesAttributesRetrieveResult.getEntityValues()){
            Map<String,Object> _EntityDataMap = new HashMap<>();
            Map<String, Object> sourceMap = _EntityValue.getEntityAttributesValue();
            if(sourceMap != null){
                ...
                _EntityDataMap.put("FOUNDED_BY","ChamberOfCommerce");
            }
            EntityValue conceptionEntityValue = new EntityValue();
            conceptionEntityValue.setEntityAttributesValue(_EntityDataMap);
            Entity newEntity = _ConceptionKind2.newEntity(conceptionEntityValue,false);
            newEntity.attachFromRelation(_EntityValue.getEntityUID(),"CPC_OrganizationFoundedBy",null,false);
        }
