...
public class AttributesMeasurableTest {
    ...
    @Test
    public void testAttributesMeasurableFunction() throws EngineServiceRuntimeException {
        ...
        if(_Type01 == null){
            _Type01 = coreRealm.createType(testConceptionKindName,"testKind01Desc+中文描述");
            Assert.assertNotNull(_Type01);
            Assert.assertEquals(_Type01.getConceptionKindName(),testConceptionKindName);
            Assert.assertEquals(_Type01.getConceptionKindDesc(),"testKind01Desc+中文描述");
        }

        EntitiesOperationResult purgeEntitiesOperationResult = _Type01.purgeAllEntities();
        ...
        Long entitiesCount = _Type01.countConceptionEntities();
        ...
        Date lastUpdateDate1 = (Date) _Entity.getAttribute(Constant._lastModifyDateProperty).getAttributeValue();
        Assert.assertNotNull(lastUpdateDate1);

        entitiesCount = _Type01.countConceptionEntities();
        Assert.assertEquals(entitiesCount,new Long(1));

        String queryUIDValue = _Entity.getEntityUID();
        Entity _queryResultEntity = _Type01.getEntityByUID(queryUIDValue);
        ...
        AttributeValue attributeValueNotExist = _queryResultEntity.getAttribute("valueNotExost");
        Assert.assertNull(attributeValueNotExist);

        AttributeValue attributeValue_prop18 = _queryResultEntity.getAttribute("prop18");
        ...
        AttributeValue attributeValue_prop16 = _queryResultEntity.getAttribute("prop16");
        ...
        AttributeValue attributeValue_prop4 = _queryResultEntity.getAttribute("prop4");
        ...
        AttributeValue attributeValue_prop5 = _queryResultEntity.getAttribute("prop5");
        ...
        AttributeValue attributeValue_prop6 = _queryResultEntity.getAttribute("prop6");
        ...
        AttributeValue attributeValue_prop7 = _queryResultEntity.getAttribute("prop7");
        ...
        Assert.assertTrue( _queryResultEntity.hasAttribute("prop1"));
        Assert.assertTrue( _queryResultEntity.hasAttribute("prop7"));
        Assert.assertTrue( _queryResultEntity.hasAttribute("prop9"));
        Assert.assertTrue( _queryResultEntity.hasAttribute("prop20"));
        Assert.assertTrue( _queryResultEntity.hasAttribute("prop21"));
        Assert.assertFalse( _queryResultEntity.hasAttribute("propNotExist"));

        AttributeValue newAddedAttributeValue1 = _queryResultEntity.addAttribute("newBooleanAttribute1",false);
        ...
        Date lastUpdateDate2 = (Date) _Entity.getAttribute(Constant._lastModifyDateProperty).getAttributeValue();
        Assert.assertNotNull(lastUpdateDate2);
        Assert.assertTrue(lastUpdateDate2.getTime() > lastUpdateDate1.getTime());

        AttributeValue newAddedAttributeValue2 = _queryResultEntity.addAttribute("newBooleanAttribute2",true);
        ...
        AttributeValue newAddedAttributeValue3 = _queryResultEntity.addAttribute("newIntAttribute",5000);
        ...
        AttributeValue newAddedAttributeValue4 = _queryResultEntity.addAttribute("newShortAttribute",Short.valueOf("25"));
        ...
        AttributeValue newAddedAttributeValue5 = _queryResultEntity.addAttribute("newLongAttribute",4566777l);
        ...
        AttributeValue newAddedAttributeValue6 = _queryResultEntity.addAttribute("newFloatAttribute",3456.9f);
        ...
        AttributeValue newAddedAttributeValue7 = _queryResultEntity.addAttribute("newDoubleAttribute",5673.999521d);
        ...
        AttributeValue newAddedAttributeValue8 = _queryResultEntity.addAttribute("newDateAttribute",targetDate);
        ...
        AttributeValue newAddedAttributeValue9 = _queryResultEntity.addAttribute("newStringAttribute","string值");
        ...
        AttributeValue newAddedAttributeValue10 = _queryResultEntity.addAttribute("newByteArrayAttribute",byteArray);
        ...
        AttributeValue newAddedAttributeValue10B = _queryResultEntity.addAttribute("newByteArrayAttributeB",_ByteArray);
        ...
        AttributeValue newAddedAttributeValue11 = _queryResultEntity.addAttribute("newByteAttribute",Byte.valueOf("1"));
        ...
        AttributeValue newAddedAttributeValue12 = _queryResultEntity.addAttribute("newDecimalAttribute",new BigDecimal(45679.23455));
        ...
        AttributeValue newAddedAttributeValue13 = _queryResultEntity.addAttribute("newBooleanArrayAttribute",new Boolean[]{false,true});
        ...
        AttributeValue newAddedAttributeValue14 = _queryResultEntity.addAttribute("newIntArrayAttribute",new Integer[]{100,200});
        ...
        AttributeValue newAddedAttributeValue15 = _queryResultEntity.addAttribute("newShortArrayAttribute",new Short[]{12,34});
        ...
        AttributeValue newAddedAttributeValue16 = _queryResultEntity.addAttribute("newLongArrayAttribute",new Long[]{444l,555l});
        ...
        AttributeValue newAddedAttributeValue17 = _queryResultEntity.addAttribute("newFloatArrayAttribute",new Float[]{123.1f,456.7f});
        ...
        AttributeValue newAddedAttributeValue18 = _queryResultEntity.addAttribute("newDoubleArrayAttribute",new Double[]{77.88d,88.99d});
        ...
        AttributeValue newAddedAttributeValue19 = _queryResultEntity.addAttribute("newDateArrayAttribute",new Date[]{arrayValue1,arrayValue2});
        ...
        AttributeValue newAddedAttributeValue20 = _queryResultEntity.addAttribute("newStringArrayAttribute",new String[]{"stringvalue1","stringvalue2"});
        ...
        AttributeValue newAddedAttributeValue21 = _queryResultEntity.addAttribute("newDecimalArrayAttribute",new BigDecimal[]{new BigDecimal(11223.23455),new BigDecimal(22334.889972)});
        ...
        try {
            _queryResultEntity.addAttribute("newDecimalArrayAttribute", Long.parseLong("12345678"));
        ...
        try {
            _queryResultEntity.updateAttribute("prop1_notExist", Long.parseLong("12345678"));
        }catch(EngineServiceRuntimeException e){
            exceptionShouldBeCaught = true;
        }
        Assert.assertTrue(exceptionShouldBeCaught);
        ...
        exceptionShouldBeCaught = false;
        try {
            _queryResultEntity.updateAttribute("prop1", Double.parseDouble("12345678"));
        }catch(EngineServiceRuntimeException e){
            exceptionShouldBeCaught = true;
        }
        Assert.assertTrue(exceptionShouldBeCaught);

        AttributeValue updatedAttributeValue_prop1 = _queryResultEntity.updateAttribute("prop1", Long.parseLong("11111"));
        ...
        Date lastUpdateDate3 = (Date) _Entity.getAttribute(Constant._lastModifyDateProperty).getAttributeValue();
        Assert.assertNotNull(lastUpdateDate3);
        Assert.assertTrue(lastUpdateDate3.getTime() > lastUpdateDate2.getTime());

        AttributeValue updatedAttributeValueConfirm_prop1 = _queryResultEntity.getAttribute("prop1");
        ...
        AttributeValue updatedAttributeValue_prop2 = _queryResultEntity.updateAttribute("prop2", Double.parseDouble("12345.111"));
        ...
        AttributeValue updatedAttributeValue_prop3 = _queryResultEntity.updateAttribute("prop3", Integer.parseInt("445566"));
        ...
        AttributeValue updatedAttributeValue_prop4 = _queryResultEntity.updateAttribute("prop4","thi is s string");
        ...
        AttributeValue updatedAttributeValue_prop5 = _queryResultEntity.updateAttribute("prop5",Boolean.valueOf("true"));
        ...
        AttributeValue updatedAttributeValue_prop6 = _queryResultEntity.updateAttribute("prop6",new BigDecimal("556674450.224"));
        ...
        AttributeValue updatedAttributeValue_prop7 = _queryResultEntity.updateAttribute("prop7",Short.valueOf("4"));
        ...
        AttributeValue updatedAttributeValue_pro8 = _queryResultEntity.updateAttribute("prop8",Float.valueOf("123434.66"));
        ...
        AttributeValue updatedAttributeValue_pro9 = _queryResultEntity.updateAttribute("prop9",new Long[]{5000l,8000l});
        ...
        AttributeValue updatedAttributeValue_pro10 = _queryResultEntity.updateAttribute("prop10",new Double[]{5000.1d,8000.2d});
        ...
        AttributeValue updatedAttributeValue_pro11 = _queryResultEntity.updateAttribute("prop11",new Integer[]{100,2,44,55});
        ...
        AttributeValue updatedAttributeValue_pro12 = _queryResultEntity.updateAttribute("prop12",new String[]{"this is str1AA","这是字符串2AA"});
        ...
        AttributeValue updatedAttributeValue_pro13 = _queryResultEntity.updateAttribute("prop13",new Boolean[]{true,true});
        ...
        AttributeValue updatedAttributeValue_pro14 = _queryResultEntity.updateAttribute("prop14",new BigDecimal[]{new BigDecimal("1234567.890"),new BigDecimal("987654321.12345")});
        ...
        AttributeValue updatedAttributeValue_pro15 = _queryResultEntity.updateAttribute("prop15",new Short[]{66,97});
        ...
        AttributeValue updatedAttributeValue_pro16 = _queryResultEntity.updateAttribute("prop16",new Float[]{5000.1f,7000.8f});
        ...
        AttributeValue updatedAttributeValue_pro17 = _queryResultEntity.updateAttribute("prop17",new Date());
        ...
        AttributeValue updatedAttributeValue_pro18 = _queryResultEntity.updateAttribute("prop18", new Date[]{new Date(),new Date()});
        ...
        AttributeValue updatedAttributeValue_pro19 = _queryResultEntity.updateAttribute("prop19", Byte.valueOf("9"));
        ...
        AttributeValue updatedAttributeValue_pro20 = _queryResultEntity.updateAttribute("prop20","this is a new byte array value".getBytes());
        ...
        AttributeValue updatedAttributeValue_pro21 = _queryResultEntity.updateAttribute("prop21",_ByteArray2);
        ...
        exceptionShouldBeCaught = false;
        try {
            _queryResultEntity.removeAttribute("prop1NotExist");
        }catch(EngineServiceRuntimeException e){
            exceptionShouldBeCaught = true;
        }
        Assert.assertTrue(exceptionShouldBeCaught);

        boolean removeAttributeResult = _queryResultEntity.removeAttribute("prop1");
        Assert.assertTrue(removeAttributeResult);
        Assert.assertFalse(_queryResultEntity.hasAttribute("prop1"));
        Assert.assertNull(_queryResultEntity.getAttribute("prop1"));

        Date lastUpdateDate4 = (Date) _Entity.getAttribute(Constant._lastModifyDateProperty).getAttributeValue();
        ...
        List<String> addAttributesResult = _queryResultEntity.addAttributes(newPropertiesMap);
        ...
        Assert.assertEquals(_queryResultEntity.getAttribute("prop7").getAttributeValue(),new Long(4));
        Assert.assertEquals(_queryResultEntity.getAttribute("newAtt1").getAttributeValue(),new Long(1000001));
        Assert.assertNotNull(_queryResultEntity.getAttribute("newAtt2").getAttributeValue());

        Date lastUpdateDate5 = (Date) _Entity.getAttribute(Constant._lastModifyDateProperty).getAttributeValue();
        ...
        List<String> updateAttributesResult = _queryResultEntity.updateAttributes(updatePropertiesMap);
        ...
        Date lastUpdateDate6 = (Date) _Entity.getAttribute(Constant._lastModifyDateProperty).getAttributeValue();
        Assert.assertNotNull(lastUpdateDate6);
        Assert.assertTrue(lastUpdateDate6.getTime() > lastUpdateDate5.getTime());

        Assert.assertEquals(_queryResultEntity.getAttribute("newAtt1").getAttributeValue(),new Long(5000001));
        Assert.assertEquals(_queryResultEntity.getAttribute("prop7").getAttributeValue(),new Long(24000));
        Assert.assertTrue(_queryResultEntity.getAttribute("newAtt2").getAttributeValue() instanceof Date);
        ...
        List<String> addAndUpdateAttributesResult = _queryResultEntity.addNewOrUpdateAttributes(addOrUpdAttributeMap);

        Assert.assertNotNull(addAndUpdateAttributesResult);
        Assert.assertEquals(addAndUpdateAttributesResult.size(),7);
        Assert.assertEquals(_queryResultEntity.getAttribute("newAtt1").getAttributeValue(),new Long(1000001));
        Assert.assertTrue(_queryResultEntity.getAttribute("newAtt2").getAttributeValue() instanceof Date);
        Assert.assertEquals(_queryResultEntity.getAttribute("prop7").getAttributeValue(),new Long(34000));
        Assert.assertEquals(_queryResultEntity.getAttribute("prop7NotExist").getAttributeValue(),new Long(66000));
        Assert.assertEquals(_queryResultEntity.getAttribute("prop22").getAttributeValue(),LocalDate.of(1999,9,9));
        LocalTime[] prop26Result = (LocalTime[]) _queryResultEntity.getAttribute("prop26").getAttributeValue();
        Assert.assertEquals(prop26Result.length,1);
        Assert.assertEquals(prop26Result[0],LocalTime.of(9,9,9));
        Assert.assertEquals(_queryResultEntity.getAttribute("newTmpProp1").getAttributeValue(),LocalDateTime.of(2022,2,2,2,2));
        LocalDate[] newTmpProp2Result = (LocalDate[]) _queryResultEntity.getAttribute("newTmpProp2").getAttributeValue();
        ...
        Date lastUpdateDate7 = (Date) _Entity.getAttribute(Constant._lastModifyDateProperty).getAttributeValue();
        ...
        AttributeValue localDateAttributeValue = _Entity.addAttribute("localDate",localDateAttribute);
        ...
        localDateAttributeValue = _Entity.getAttribute("localDate");
        Assert.assertNotNull(localDateAttributeValue);
        ...
        AttributeValue localDateTimeAttributeValue = _Entity.addAttribute("localDateTime",localDateTimeAttribute);
        ...
        localDateTimeAttributeValue = _Entity.getAttribute("localDateTime");
        Assert.assertNotNull(localDateTimeAttributeValue);
        ...
        AttributeValue localTimeAttributeValue = _Entity.addAttribute("localTime",localTimeAttribute);
        ...
        localTimeAttributeValue = _Entity.getAttribute("localTime");
        Assert.assertNotNull(localTimeAttributeValue);
        ...
        AttributeValue localDateArrayAttributeValue = _Entity.addAttribute("localDateArray",localDateArrayAttribute);
        ...
        localDateArrayAttributeValue = _Entity.getAttribute("localDateArray");
        Assert.assertNotNull(localDateArrayAttributeValue);
        ...
        AttributeValue localTimeArrayAttributeValue = _Entity.addAttribute("localTimeArray",localTimeArrayAttribute);
        ...
        localTimeArrayAttributeValue = _Entity.getAttribute("localTimeArray");
        Assert.assertNotNull(localTimeArrayAttributeValue);
        ...
        AttributeValue localDateTimeArrayAttributeValue = _Entity.addAttribute("localDateTimeArray",localDateTimeArrayAttribute);
        ...
        localDateTimeArrayAttributeValue = _Entity.getAttribute("localDateTimeArray");
        Assert.assertNotNull(localDateTimeArrayAttributeValue);
        ...
        localDateAttributeValue = _Entity.updateAttribute("localDate",localDateAttribute2);
        Assert.assertNotNull(localDateAttributeValue);
        Assert.assertEquals(localDateAttributeValue.getAttributeDataType(),AttributeDataType.DATE);
        localDateAttributeValue = _Entity.getAttribute("localDate");
        Assert.assertNotNull(localDateAttributeValue);
        ...
        localTimeAttributeValue = _Entity.updateAttribute("localTime",localTimeAttribute2);
        Assert.assertNotNull(localTimeAttributeValue);
        Assert.assertEquals(localTimeAttributeValue.getAttributeDataType(),AttributeDataType.TIME);
        localTimeAttributeValue = _Entity.getAttribute("localTime");
        Assert.assertNotNull(localTimeAttributeValue);
        ...
        localDateTimeAttributeValue = _Entity.updateAttribute("localDateTime",localDateTimeAttribute2);
        Assert.assertNotNull(localDateTimeAttributeValue);
        Assert.assertEquals(localDateTimeAttributeValue.getAttributeDataType(),AttributeDataType.DATETIME);
        localDateTimeAttributeValue = _Entity.getAttribute("localDateTime");
        Assert.assertNotNull(localDateTimeAttributeValue);
        ...
        localDateArrayAttributeValue = _Entity.updateAttribute("localDateArray",localDateArrayAttribute2);
        Assert.assertNotNull(localDateArrayAttributeValue);
        Assert.assertEquals(localDateArrayAttributeValue.getAttributeDataType(),AttributeDataType.DATE_ARRAY);
        localDateArrayAttributeValue = _Entity.getAttribute("localDateArray");
        Assert.assertNotNull(localDateArrayAttributeValue);
        ...
        localTimeArrayAttributeValue = _Entity.updateAttribute("localTimeArray",localTimeArrayAttribute2);
        Assert.assertNotNull(localTimeArrayAttributeValue);
        Assert.assertEquals(localTimeArrayAttributeValue.getAttributeDataType(),AttributeDataType.TIME_ARRAY);
        localTimeArrayAttributeValue = _Entity.getAttribute("localTimeArray");
        Assert.assertNotNull(localTimeArrayAttributeValue);
        ...
        localDateTimeArrayAttributeValue = _Entity.updateAttribute("localDateTimeArray",localDateTimeArrayAttribute2);
        Assert.assertNotNull(localDateTimeArrayAttributeValue);
        Assert.assertEquals(localDateTimeArrayAttributeValue.getAttributeDataType(),AttributeDataType.DATETIME_ARRAY);
        localDateTimeArrayAttributeValue = _Entity.getAttribute("localDateTimeArray");
        Assert.assertNotNull(localDateTimeArrayAttributeValue);
        ...
        AttributeValue spaceNameAttributeValue = _Entity.addAttribute("attrwith space","iam stringwithspace");
        ...
        spaceNameAttributeValue = _Entity.getAttribute("attrwith space");
        Assert.assertEquals(spaceNameAttributeValue.getAttributeName(),"attrwith space");
        Assert.assertEquals(spaceNameAttributeValue.getAttributeValue().toString(),"iam stringwithspace");

        spaceNameAttributeValue = _Entity.updateAttribute("attrwith space","iam stringwithspace2233");
        Assert.assertEquals(spaceNameAttributeValue.getAttributeName(),"attrwith space");
        Assert.assertEquals(spaceNameAttributeValue.getAttributeValue().toString(),"iam stringwithspace2233");

        boolean removeSpaceAttributeResult = _Entity.removeAttribute("attrwith space");
        Assert.assertTrue(removeSpaceAttributeResult);
        boolean shouldThrowException = false;
        try {
            removeSpaceAttributeResult = _Entity.removeAttribute("attrwith space");
        }catch (EngineServiceRuntimeException e){
