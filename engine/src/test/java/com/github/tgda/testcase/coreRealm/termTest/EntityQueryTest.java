...
public class EntityQueryTest {
    ...
    @Test
    public void testEntityQueryFunction() throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        ...
        for(int i=0 ; i<100 ; i++){
            entityValueList.add(generateRandomEntityValue());
        }
        _ConceptionKind01.newEntities(entityValueList,false);
        ...
        _ConceptionKind01.newEntity(entityValue,false);

        newEntityValueMap.put("prop3",Integer.parseInt("1234"));
        newEntityValueMap.put("prop5",Boolean.valueOf("false"));
        entityValue = new EntityValue(newEntityValueMap);
        _ConceptionKind01.newEntity(entityValue,false);
        ...
        EntitiesRetrieveResult entitiesRetrieveResult = _ConceptionKind01.getEntities(queryParameters);
        Assert.assertNotNull(entitiesRetrieveResult.getOperationStatistics());
        Assert.assertNotNull(entitiesRetrieveResult.getOperationStatistics().getStartTime());
        Assert.assertNotNull(entitiesRetrieveResult.getOperationStatistics().getFinishTime());
        Assert.assertNotNull(entitiesRetrieveResult.getOperationStatistics().getQueryParameters());
        Assert.assertTrue(entitiesRetrieveResult.getOperationStatistics().getFinishTime().getTime() >
                        entitiesRetrieveResult.getOperationStatistics().getStartTime().getTime());
        Assert.assertTrue(entitiesRetrieveResult.getOperationStatistics().getResultEntitiesCount() >0);
        Assert.assertNotNull(entitiesRetrieveResult.getConceptionEntities());
        Assert.assertTrue(entitiesRetrieveResult.getConceptionEntities().size() >0);
        ...
        long res1 = (entitiesRetrieveResult.getOperationStatistics().getResultEntitiesCount());
        ...
        entitiesRetrieveResult = _ConceptionKind01.getEntities(nullValueQueryParameters);
        Assert.assertTrue(entitiesRetrieveResult.getConceptionEntities().size() >0);
        ...
        EntitiesAttributesRetrieveResult entitiesAttributesRetrieveResult1 = _ConceptionKind01.getSingleValueEntityAttributesByAttributeNames(attributesNameList,queryParameters);
        ...
        List<EntityValue> resEntityValueList01 = entitiesAttributesRetrieveResult1.getEntityValues();
        ...
        for(EntityValue currentEntityValue :resEntityValueList01){
            String entityUID = currentEntityValue.getEntityUID();
            Map<String,Object> entityValueMap = currentEntityValue.getEntityAttributesValue();
        ...
        for(EntityValue currentEntityValue :entitiesAttributesRetrieveResult1.getEntityValues()){
            String entityUID = currentEntityValue.getEntityUID();
            Map<String,Object> entityValueMap = currentEntityValue.getEntityAttributesValue();
        ...
        EntitiesAttributesRetrieveResult entitiesAttributesRetrieveResult2 = _ConceptionKind01.getSingleValueEntityAttributesByViewKinds(targetAttributesViewKindList,queryParameters);
        ...
        List<EntityValue> resEntityValueList02 = entitiesAttributesRetrieveResult2.getEntityValues();
        ...
        for(EntityValue currentEntityValue :resEntityValueList02){
            String entityUID = currentEntityValue.getEntityUID();
            Map<String,Object> entityValueMap = currentEntityValue.getEntityAttributesValue();
            Assert.assertNotNull(entityUID);
            Assert.assertNotNull(entityValueMap);
        ...
        EntityValue entityValue2 = new EntityValue(newEntityValue);
        Entity _Entity = _ConceptionKind02.newEntity(entityValue2,false);
        ...
        EntitiesAttributesRetrieveResult entitiesAttributesRetrieveResult3 = _ConceptionKind02.getSingleValueEntityAttributesByAttributeNames(attributesNameList2,queryParameters2);
        List<EntityValue> resultEntityValueList = entitiesAttributesRetrieveResult3.getEntityValues();
        Assert.assertNotNull(resultEntityValueList);
        ...
        resultEntityValueList = entitiesAttributesRetrieveResult3.getEntityValues();
        Assert.assertNotNull(resultEntityValueList);
        Assert.assertEquals(resultEntityValueList.size(),1);

        EntityValue targetEntityValue = resultEntityValueList.get(0);
        Map<String,Object> attributesValueMap = targetEntityValue.getEntityAttributesValue();
        Assert.assertNotNull(targetEntityValue.getEntityUID());
        ...
        EntitiesAttributesRetrieveResult entitiesAttributesRetrieveResult4 = _ConceptionKind02.getSingleValueEntityAttributesByViewKinds(targetAttributesViewKindList2,queryParameters2);
        ...
        List<EntityValue> resultEntityValueList4 = entitiesAttributesRetrieveResult4.getEntityValues();
        Assert.assertNotNull(resultEntityValueList4);
        Assert.assertEquals(resultEntityValueList4.size(),1);

        EntityValue targetEntityValue2 = resultEntityValueList4.get(0);
        Map<String,Object> attributesValueMap2 = targetEntityValue2.getEntityAttributesValue();
        Assert.assertNotNull(targetEntityValue2.getEntityUID());
    ...
    private EntityValue generateRandomEntityValue(){
        Map<String,Object> newEntityValueMap= new HashMap<>();
        ...
        */
        return new EntityValue(newEntityValueMap);
    }
