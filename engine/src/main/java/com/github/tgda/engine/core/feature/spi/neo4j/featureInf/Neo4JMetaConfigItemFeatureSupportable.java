...
public interface Neo4JMetaConfigItemFeatureSupportable extends MetaConfigItemFeatureSupportable,Neo4JKeyResourcesRetrievable  {
    ...
    private Long getStorageNodeUID(GraphOperationExecutor workingGraphOperationExecutor){
        /*
            ...
            MERGE (sourceNode)-[:`TGDA_MetaConfigItemsStorageIs`]->(operationResult:`TGDA_MetaConfigItemsStorage`)
        ...
        */
        String storageNodeQueryCql = CypherBuilder.mergeRelatedNodesFromSpecialStartNodes(
                ...
                Constant.MetaConfigItemsStorageClass, Constant.Kind_MetaConfigItemsStorageRelationClass, Direction.TO, null);
