...
import com.github.tgda.engine.core.payload.AnalyzableGraphAttributeInfo;
import com.github.tgda.engine.core.payload.GraphDegreeDistributionInfo;
...
public class GetSingleAnalyzableGraphTransformer implements DataTransformer<AnalyzableGraph>{
    ...
    public AnalyzableGraph transformResult(Result result) {
        ...
        if(result.hasNext()){
            ...
            analyzableGraph.setEntityCount(conceptionEntityCount);
            analyzableGraph.setRelationshipEntityCount(relationEntityCount);
