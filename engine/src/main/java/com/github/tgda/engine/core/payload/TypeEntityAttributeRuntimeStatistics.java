...
public class TypeEntityAttributeRuntimeStatistics {
    ...
    public TypeEntityAttributeRuntimeStatistics(String kindName, String attributeName, String attributeDataTypeValue, long sampleCount, long attributeHitCount){
