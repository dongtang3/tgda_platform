...
import com.github.tgda.coreRealm.realmServiceCore.operator.configuration.dataScienceConfig.*;
import com.github.tgda.engine.core.payload.AnalyzableGraph;
import com.github.tgda.coreRealm.realmServiceCore.payload.dataScienceAnalyzeResult.*;
...
public class Neo4JDataScienceOperatorImpl implements DataScienceOperator {
    ...
    public AnalyzableGraph createAnalyzableGraph(String graphName,List<String> conceptionKindList,Set<String> conceptionKindAttributeSet,
        ...
        */
        if(conceptionKindList == null || conceptionKindList.size() == 0){
            ...
            EngineServiceRuntimeException e = new EngineServiceRuntimeException();
    ...
    @Override
    public AnalyzableGraph createAnalyzableGraph(String graphName, Set<ConceptionKindComputeConfig> conceptionKindsConfig, Set<RelationKindComputeConfig> relationKindsConfig) throws EngineServiceRuntimeException {
        /*
        Example:
    ...
    @Override
    public AnalyzableGraph createAnalyzableGraph(String graphName, String conceptionEntitiesQuery, String relationEntitiesQuery) throws EngineServiceRuntimeException {
        /*
        Example:
    ...
    public DijkstraSourceTargetAlgorithmResult executeDijkstraSourceTargetAlgorithm(String graphName, DijkstraSourceTargetAlgorithmConfig dijkstraSourceTargetAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        ...
        */
        ...
        if(dijkstraSourceTargetAlgorithmConfig == null || dijkstraSourceTargetAlgorithmConfig.getSourceEntityUID() == null
                || dijkstraSourceTargetAlgorithmConfig.getTargetEntityUID() == null){
            logger.error("Both sourceEntityUID and targetEntityUID are required",graphName);
            EngineServiceRuntimeException e = new EngineServiceRuntimeException();
            e.setCauseMessage("Both sourceEntityUID and targetEntityUID are required");
            throw e;
        }
        ...
        String cypherProcedureString =
                "MATCH (startNode) WHERE id(startNode)= "+dijkstraSourceTargetAlgorithmConfig.getSourceEntityUID()+"\n" +
                "MATCH (endNode) WHERE id(endNode)= "+dijkstraSourceTargetAlgorithmConfig.getTargetEntityUID()+"\n" +
    ...
    public DijkstraSingleSourceAlgorithmResult executeDijkstraSingleSourceAlgorithm(String graphName, DijkstraSingleSourceAlgorithmConfig dijkstraSingleSourceAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        ...
        */
        ...
        if(dijkstraSingleSourceAlgorithmConfig == null || dijkstraSingleSourceAlgorithmConfig.getSourceEntityUID() == null){
            logger.error("sourceEntityUID is required",graphName);
            EngineServiceRuntimeException e = new EngineServiceRuntimeException();
            e.setCauseMessage("sourceEntityUID is required");
            throw e;
        }
        ...
        String cypherProcedureString =
             "MATCH (startNode) WHERE id(startNode)= "+dijkstraSingleSourceAlgorithmConfig.getSourceEntityUID()+"\n" +
    ...
    public AStarShortestPathAlgorithmResult executeAStarShortestPathAlgorithm(String graphName, AStarShortestPathAlgorithmConfig aStarShortestPathAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        ...
        */
        ...
        if(aStarShortestPathAlgorithmConfig == null || aStarShortestPathAlgorithmConfig.getSourceEntityUID() == null
                || aStarShortestPathAlgorithmConfig.getTargetEntityUID() == null){
            logger.error("Both sourceEntityUID and targetEntityUID are required",graphName);
            EngineServiceRuntimeException e = new EngineServiceRuntimeException();
            e.setCauseMessage("Both sourceEntityUID and targetEntityUID are required");
            throw e;
        ...
        String cypherProcedureString =
                "MATCH (startNode) WHERE id(startNode)= "+aStarShortestPathAlgorithmConfig.getSourceEntityUID()+"\n" +
                        "MATCH (endNode) WHERE id(endNode)= "+aStarShortestPathAlgorithmConfig.getTargetEntityUID()+"\n" +
    ...
    public YensKShortestPathAlgorithmResult executeYensKShortestPathAlgorithm(String graphName, YensKShortestPathAlgorithmConfig yensKShortestPathAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        ...
        */
        ...
        if(yensKShortestPathAlgorithmConfig == null || yensKShortestPathAlgorithmConfig.getSourceEntityUID() == null
                || yensKShortestPathAlgorithmConfig.getTargetEntityUID() == null){
            logger.error("Both sourceEntityUID and targetEntityUID are required",graphName);
            EngineServiceRuntimeException e = new EngineServiceRuntimeException();
            e.setCauseMessage("Both sourceEntityUID and targetEntityUID are required");
            throw e;
        ...
        String cypherProcedureString =
                "MATCH (startNode) WHERE id(startNode)= "+yensKShortestPathAlgorithmConfig.getSourceEntityUID()+"\n" +
                        "MATCH (endNode) WHERE id(endNode)= "+yensKShortestPathAlgorithmConfig.getTargetEntityUID()+"\n" +
    ...
    public RandomWalkAlgorithmResult executeRandomWalkAlgorithm(String graphName, RandomWalkAlgorithmConfig randomWalkAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        ...
        */
        ...
        if(randomWalkAlgorithmConfiguration.getSourceEntityUIDs() != null &&
                randomWalkAlgorithmConfiguration.getSourceEntityUIDs().size() > 0){
            startPropertyStr = "  start: "+ randomWalkAlgorithmConfiguration.getSourceEntityUIDs().toString()+",\n";
    ...
    public SingleSourceShortestPathAlgorithmResult executeSingleSourceShortestPathAlgorithm(String graphName, SingleSourceShortestPathAlgorithmConfig singleSourceShortestPathAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        ...
        */
        ...
        if(singleSourceShortestPathAlgorithmConfig == null || singleSourceShortestPathAlgorithmConfig.getSourceEntityUID() == null){
            logger.error("SourceEntityUID is required",graphName);
            EngineServiceRuntimeException e = new EngineServiceRuntimeException();
            e.setCauseMessage("SourceEntityUID is required");
            throw e;
        ...
        String cypherProcedureString =
                "MATCH (startNode) WHERE id(startNode)= "+singleSourceShortestPathAlgorithmConfig.getSourceEntityUID()+"\n" +
    ...
    public BreadthFirstSearchAlgorithmResult executeBreadthFirstSearchAlgorithm(String graphName, BreadthFirstSearchAlgorithmConfig breadthFirstSearchAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        ...
        */
        ...
        if(breadthFirstSearchAlgorithmConfig == null || breadthFirstSearchAlgorithmConfig.getSourceEntityUID() == null){
            logger.error("SourceEntityUID is required",graphName);
            EngineServiceRuntimeException e = new EngineServiceRuntimeException();
            e.setCauseMessage("SourceEntityUID is required");
            throw e;
        ...
        String startNodeIdPropertyStr = "  startNode: "+ breadthFirstSearchAlgorithmConfig.getSourceEntityUID()+",\n";
        String maxDepthPropertyStr = "  maxDepth: "+ breadthFirstSearchAlgorithmConfig.getMaxDepth()+",\n";
        String terminateNodesCQLPart = "";
        Set terminateEntityUIDSet = breadthFirstSearchAlgorithmConfig.getTerminateAtEntityUIDs();
        if(terminateEntityUIDSet != null && terminateEntityUIDSet.size()>0){
            terminateNodesCQLPart = "  targetNodes: "+terminateEntityUIDSet+",\n";
        }
    ...
    public DepthFirstSearchAlgorithmResult executeDepthFirstSearchAlgorithm(String graphName, DepthFirstSearchAlgorithmConfig depthFirstSearchAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        ...
        */
        ...
        if(depthFirstSearchAlgorithmConfig == null || depthFirstSearchAlgorithmConfig.getSourceEntityUID() == null){
            logger.error("SourceEntityUID is required",graphName);
            EngineServiceRuntimeException e = new EngineServiceRuntimeException();
            e.setCauseMessage("SourceEntityUID is required");
            throw e;
        ...
        String startNodeIdPropertyStr = "  startNode: "+ depthFirstSearchAlgorithmConfig.getSourceEntityUID()+",\n";
        String maxDepthPropertyStr = "  maxDepth: "+ depthFirstSearchAlgorithmConfig.getMaxDepth()+",\n";
        String terminateNodesCQLPart = "";
        Set terminateEntityUIDSet = depthFirstSearchAlgorithmConfig.getTerminateAtEntityUIDs();
        if(terminateEntityUIDSet != null && terminateEntityUIDSet.size()>0){
            terminateNodesCQLPart = "  targetNodes: "+terminateEntityUIDSet+",\n";
        }
    ...
    private PageRankAlgorithmResult doExecutePageRankAlgorithms(String graphName, Set<String> conceptionEntityUIDSet,PageRankAlgorithmConfig pageRankAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        /*
        Example:
    ...
    private ArticleRankAlgorithmResult doExecuteArticleRankAlgorithms(String graphName, Set<String> conceptionEntityUIDSet,ArticleRankAlgorithmConfig articleRankAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        /*
        Example:
    ...
    private EigenvectorCentralityAlgorithmResult doExecuteEigenvectorCentrality(String graphName, Set<String> conceptionEntityUIDSet,EigenvectorCentralityAlgorithmConfig eigenvectorCentralityAlgorithmConfig) throws EngineServiceRuntimeException, EngineServiceEntityExploreException {
        /*
        Example:
    ...
    private String getRankAlgorithmsCQL(String graphName, String algorithm,Set<String> conceptionEntityUIDSet,PageRankAlgorithmConfig pageRankAlgorithmConfig,boolean usingDampingFactor) throws EngineServiceEntityExploreException {
    ...
    private String getReturnDataControlLogic(ResultPaginationableConfig resultPaginationAbleConfig) throws EngineServiceEntityExploreException {
    ...
    private AnalyzableGraph executeCreateAnalyzableGraphOperation(String graphName,String cypherProcedureString) throws EngineServiceRuntimeException {
    ...
    private void checkGraphExistence(String graphName) throws EngineServiceRuntimeException {
        boolean checkGraphExistence = checkAnalyzableGraphExistence(graphName);
        if(!checkGraphExistence){
