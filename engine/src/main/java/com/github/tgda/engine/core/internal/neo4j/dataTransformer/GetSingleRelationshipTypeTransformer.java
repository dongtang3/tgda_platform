...
public class GetSingleRelationshipTypeTransformer implements DataTransformer<RelationshipType> {

    private GraphOperationExecutor workingGraphOperationExecutor;
    private String currentCoreRealmName;

    public GetSingleRelationshipTypeTransformer(String currentCoreRealmName, GraphOperationExecutor workingGraphOperationExecutor){
        this.currentCoreRealmName= currentCoreRealmName;
        this.workingGraphOperationExecutor = workingGraphOperationExecutor;
    }

    @Override
    public RelationshipType transformResult(Result result) {
        if(result.hasNext()){
