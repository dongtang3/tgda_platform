...
import com.github.tgda.engine.core.operator.configuration.dataScienceConfig.PageRankAlgorithmConfig;
...
public class PageRankAlgorithmResult {
    ...
    private List<EntityAnalyzeResult> pageRankScores;
    ...
    public List<EntityAnalyzeResult> getPageRankScores() {
