...
public interface Neo4JMultiConceptionKindsSupportable extends MultiConceptionKindsSupportable,Neo4JKeyResourcesRetrievable{
    ...
    default boolean joinConceptionKinds(String[] newKindNames) throws EngineServiceRuntimeException {
    ...
    default boolean retreatFromConceptionKind(String kindName) throws EngineServiceRuntimeException {
        if(kindName == null){
