...
import com.github.tgda.engine.core.internal.neo4j.dataTransformer.GetListAttributeSystemInfoTransformer;
import com.github.tgda.engine.core.internal.neo4j.dataTransformer.GetLongFormatReturnValueTransformer;
import com.github.tgda.engine.core.internal.neo4j.dataTransformer.GetMapAttributeSystemInfoTransformer;
            ...
            DataTransformer<DataStatusSnapshotInfo> staticHandleDataTransformer = new DataTransformer() {
                ...
                public DataStatusSnapshotInfo transformResult(Result result) {
                    if(result.hasNext()){
                        ...
                        long wholeEntityCount = ((Number) staticResultMap.get("nodeCount")).longValue();
                        long wholeRelationshipEntityCount = ((Number) staticResultMap.get("relCount")).longValue();
                        ...
                        DataStatusSnapshotInfo dataStatusSnapshotInfo = new DataStatusSnapshotInfo(wholeEntityCount,
                                wholeRelationshipEntityCount,wholeConceptionKindCount,wholeRelationKindCount,wholePhysicAttributeNameCount,
            ...
            DataTransformer<Set<ConceptionKindCorrelationInfo>> statisticsDataTransformer = new DataTransformer(){
                ...
                public Set<ConceptionKindCorrelationInfo> transformResult(Result result) {
                    ...
                    for(Object currentRelationshipObj:relationshipsList){
                        ...
                        if(conceptionKindId_nameMapping.get(startConceptionKindId).startsWith(Constant.RealmInnerTypePerFix) &
                                conceptionKindId_nameMapping.get(endConceptionKindId).startsWith(Constant.RealmInnerTypePerFix)){
                        }else{
        ...
        if(attachInfoString.startsWith("()-[:") & attachInfoString.endsWith("]->()")){
            ...
            if(attachInfoString.startsWith("()-[:")){
                ...
                RuntimeRelationAndConceptionKindAttachInfo runtimeRelationAndConceptionKindAttachInfo =
                        new RuntimeRelationAndConceptionKindAttachInfo(relationType,conceptionType, Direction.TO,relationEntityCount);
            ...
            if(attachInfoString.endsWith("]->()")){
                ...
                RuntimeRelationAndConceptionKindAttachInfo runtimeRelationAndConceptionKindAttachInfo =
                        new RuntimeRelationAndConceptionKindAttachInfo(relationType,conceptionType, Direction.FROM,relationEntityCount);
                return runtimeRelationAndConceptionKindAttachInfo;
            }
        }
        return null;
