...
public class GetListAttributeTransformer implements DataTransformer<List<Attribute>>{

    private GraphOperationExecutor workingGraphOperationExecutor;
    private String currentCoreRealmName;

    public GetListAttributeTransformer(String currentCoreRealmName, GraphOperationExecutor workingGraphOperationExecutor){
        this.currentCoreRealmName= currentCoreRealmName;
        this.workingGraphOperationExecutor = workingGraphOperationExecutor;
    }

    @Override
    public List<Attribute> transformResult(Result result) {
        List<Attribute> attributeKindsList = new ArrayList<>();
        if(result.hasNext()){
