...
import com.github.tgda.engine.core.feature.PathTravelable;
...
public interface Neo4JPathTravelable extends PathTravelable,Neo4JKeyResourcesRetrievable {
    ...
    enum AdvancedExpandType {Path , Graph , SpanningTree , EndEntity}
    enum PathEntityType {Entity , RelationshipEntity}

    default public List<EntitiesPath> expandPath(List<RelationKindMatchLogic> relationKindMatchLogics, Direction defaultDirectionForNoneRelationKindMatch,
    ...
    default public EntitiesGraph expandGraph(List<RelationKindMatchLogic> relationKindMatchLogics, Direction defaultDirectionForNoneRelationKindMatch,
    ...
    default public EntitiesSpanningTree expandSpanningTree(List<RelationKindMatchLogic> relationKindMatchLogics, Direction defaultDirectionForNoneRelationKindMatch,
    ...
    default public List<EntitiesPath> advancedExpandPath(TravelParameters travelParameters) throws EngineServiceEntityExploreException {
        /*
        Example:
    ...
    default public EntitiesGraph advancedExpandGraph(TravelParameters travelParameters) throws EngineServiceEntityExploreException {
        /*
        Example:
    ...
    default public EntitiesSpanningTree advancedExpandSpanningTree(TravelParameters travelParameters) throws EngineServiceEntityExploreException {
        /*
        Example:
        https://neo4j.com/labs/apoc/4.1/graph-querying/expand-spanning-tree/
        */
    ...
    default public List<Entity> getEndConceptionEntitiesByPathPattern(TravelParameters travelParameters) throws EngineServiceEntityExploreException {
        String cypherProcedureString = getAdvancedExpandQuery(AdvancedExpandType.EndEntity,travelParameters);
        if(this.getEntityUID() != null) {
            GraphOperationExecutor workingGraphOperationExecutor = getGraphOperationExecutorHelper().getWorkingGraphOperationExecutor();
    ...
    default List<EntitiesPath> getAllPathBetweenEntity(String targetEntityUID, List<RelationKindMatchLogic> relationKindMatchLogics,
                                                       ...
                                                       PathEntityFilterParameters relationPathEntityFilterParameters, PathEntityFilterParameters conceptionPathEntityFilterParameters) throws EngineServiceEntityExploreException {
        /*
        Example:
        ...
        */
        ...
        String relationPathEntityFilter = generatePathEntityFilterQuery(relationPathEntityFilterParameters,"path",PathEntityType.RelationshipEntity,"WHERE");
        ...
        String conceptionPathEntityFilter = generatePathEntityFilterQuery(conceptionPathEntityFilterParameters,"path",PathEntityType.Entity,conjunctionKey);
    ...
    default List<EntitiesPath> getLongestPathsBetweenEntity(String targetEntityUID, List<RelationKindMatchLogic> relationKindMatchLogics,
                                                            Direction defaultDirectionForNoneRelationKindMatch, int maxJump, int maxPath,
                                                            PathEntityFilterParameters relationPathEntityFilterParameters, PathEntityFilterParameters conceptionPathEntityFilterParameters) throws EngineServiceEntityExploreException {
        /*
        Example:
        https://neo4j.com/labs/apoc/4.1/overview/apoc.algo/apoc.algo.allSimplePaths/
    ...
    private String generateShortPathsQuery(String pathFindingFunction,String targetEntityUID, List<String> pathAllowedRelationKinds, int maxJump,
        ...
        */
        ...
        p = shortestPath((startNode)-[*..10]-(endNode))   //OR p = shortestPath((startNode)-[*]-(endNode))  // OR p = allshortestPaths((startNode)-[:TGDA_GS_SpatialConnect1|TGDA_GS_SpatialConnect*..20]-(endNode))
        ...
        */
        ...
        String relationPathEntityFilter = generatePathEntityFilterQuery(relationPathEntityFilterParameters,"p",PathEntityType.RelationshipEntity,"AND");
        String relationEntityFilterLogic = relationPathEntityFilter.equals("")?"":relationPathEntityFilter+"\n";
        String conceptionPathEntityFilter = generatePathEntityFilterQuery(conceptionPathEntityFilterParameters,"p",PathEntityType.Entity,"AND");
        String conceptionEntityFilterLogic = conceptionPathEntityFilter.equals("")?"":conceptionPathEntityFilter+"\n";
    ...
    private String generatePathEntityFilterQuery(PathEntityFilterParameters pathEntityFilterParameters,String pathElementName,PathEntityType pathEntityType,String conjunctionKey) throws EngineServiceEntityExploreException {
            ...
            for(List<? extends EntityKindMatchLogic> currentEntityKindMatchLogicsList : entityPathFlowMatchLogics){
                if(currentEntityKindMatchLogicsList.size()>0){
                    ...
                    if(currentEntityKindMatchLogicsList.get(0) instanceof ConceptionKindMatchLogic){
                        List<ConceptionKindMatchLogic> currentEntityKindMatchLogics = (List<ConceptionKindMatchLogic>)currentEntityKindMatchLogicsList;
                        currentQueryString = CypherBuilder.generateConceptionKindMatchLogicsQuery(currentEntityKindMatchLogics);
                    }
                    if(currentEntityKindMatchLogicsList.get(0) instanceof RelationKindMatchLogic){
                        List<RelationKindMatchLogic> currentRelationshipEntityKindMatchLogics = (List<RelationKindMatchLogic>)currentEntityKindMatchLogicsList;
                        currentQueryString = CypherBuilder.generateRelationKindMatchLogicsQuery(currentRelationshipEntityKindMatchLogics,null);
                    }
                    if(isFirstMatchLogic){
                        resultFullQueryString = currentQueryString;
                        if(!resultFullQueryString.equals("")){
    ...
    private String getAdvancedExpandQuery(AdvancedExpandType advancedExpandType,TravelParameters travelParameters) throws EngineServiceEntityExploreException {
        ...
        switch (advancedExpandType){
            ...
            case SpanningTree: apocProcedure = "apoc.path.spanningTree";
                break;
            case EndEntity: apocProcedure = "apoc.path.expandConfig";
        }
        ...
        if(travelParameters != null){
            ...
            switch (advancedExpandType){
                ...
                case SpanningTree: minJumpNumber = travelParameters.getMinJump() == 0 ? 0 : 1;
                    break;
                case EndEntity: minJumpNumber = travelParameters.getMinJump() >= 0 ? travelParameters.getMinJump() : 0;
            }
            int maxJumpNumber;
            ...
            Direction direction = travelParameters.getDefaultDirectionForNoneRelationKindMatch();
            String relationshipFilter = CypherBuilder.generateRelationKindMatchLogicsQuery(relationKindMatchLogicList, direction);
            ...
            List<String> endNodesUIDList = travelParameters.getEndWithEntityUIDs();
            List<String> terminatorNodesUIDList = travelParameters.getTerminateAtEntityUIDs();
            List<String> whitelistNodesUIDList = travelParameters.getMustHaveEntityUIDs();
            List<String> blacklistNodesUIDList = travelParameters.getNotAllowEntityUIDs();
            ...
            String relationPathEntityFilter = generatePathEntityFilterQuery(travelParameters.getRelationPathEntityFilterParameters(),"path",PathEntityType.RelationshipEntity,"WHERE");
            String relationEntityFilterLogic = relationPathEntityFilter.equals("")?"":relationPathEntityFilter+"\n";
            String conjunctionKey = relationEntityFilterLogic.equals("") ? "WHERE" : "AND";
            String conceptionPathEntityFilter = generatePathEntityFilterQuery(travelParameters.getConceptionPathEntityFilterParameters(),"path",PathEntityType.Entity,conjunctionKey);
            String conceptionEntityFilterLogic = conceptionPathEntityFilter.equals("")?"":conceptionPathEntityFilter+"\n";
            ...
            switch (advancedExpandType){
                case Path:
                    cypherProcedureString = "MATCH (n) WHERE id(n)= "+this.getEntityUID()+"\n" +
                            ...
                            "   bfs: "+usingBFS+",\n" +
                            "   filterStartNode: "+travelParameters.isMatchStartEntity()+",\n" +
                            "   limit: "+resultNumber+",\n" +
