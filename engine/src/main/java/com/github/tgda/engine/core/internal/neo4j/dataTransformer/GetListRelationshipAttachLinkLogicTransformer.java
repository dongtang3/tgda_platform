...
import static com.github.tgda.engine.core.term.RelationshipAttach.LinkLogicCondition.ContainSimilar;
import static com.github.tgda.engine.core.term.RelationshipAttach.LinkLogicType.*;

public class GetListRelationshipAttachLinkLogicTransformer implements DataTransformer<List<RelationshipAttachLinkLogic>>{

    private GraphOperationExecutor workingGraphOperationExecutor;
    private String currentCoreRealmName;

    public GetListRelationshipAttachLinkLogicTransformer(String currentCoreRealmName, GraphOperationExecutor workingGraphOperationExecutor){
        this.currentCoreRealmName= currentCoreRealmName;
        this.workingGraphOperationExecutor = workingGraphOperationExecutor;
    }

    @Override
    public List<RelationshipAttachLinkLogic> transformResult(Result result) {
        List<RelationshipAttachLinkLogic> relationshipAttachLinkLogicsList = new ArrayList<>();
        if(result.hasNext()) {
            while (result.hasNext()) {
                ...
                if(nodeRecord != null){
                    ...
                    relationshipAttachLinkLogicsList.add(relationshipAttachLinkLogic);
                }
            }
        }
        return relationshipAttachLinkLogicsList;
    }
